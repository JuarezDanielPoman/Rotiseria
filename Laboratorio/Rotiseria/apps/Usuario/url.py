...
from .views import creacion_cadete,logout_view,buscar_cadetes,login_view, buscar_personas,lista_cadetes,lista_personas,persona_edit, creacion_cliente, persona_delete, persona_detalle, registrarUsuario
